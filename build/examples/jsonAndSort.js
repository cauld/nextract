...
transform.loadPlugins('Core', ['Input', 'Output', 'Sort', 'Logger']).then(function () {
  ...
  .pipe(transform.Plugins.Core.Output.toJsonString(true)).pipe(transform.Plugins.Core.Output.toFile(sampleEmployeesOutputFilePath)).on('data', function (resultingData) {
