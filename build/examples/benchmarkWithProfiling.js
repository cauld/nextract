...
function runStep(stepKey, stepPromise) {
  return new Promise(function (resolve) {
    ...
    stepPromise.then(function (stepData) {
...
etlJob.loadPlugins('Core', ['Database', 'Filter', 'Calculator', 'Sort', 'Utils', 'Logger']).then(function () {
  ...
  var joinSQL = 'select page_namespace, page_title, page_restrictions, page_counter, page_is_redirect, page_is_new, page_random,' + 'page_touched, page_latest, page_len from page where page_id = :page_id';
